...
After the operation print the amount left in the Bank account. If the debit amount is
reater than current balance print "Insufficient Funds"(without quotes) and the operation is skipped.
